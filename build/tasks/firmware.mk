...
# $12 Module board id
# $13 Module sku
# $14 Bootloader dtb path w/o suffix
...
$(strip $1)/br_bct_BR.bct: $(INSTALLED_KERNEL_TARGET) $(INSTALLED_CBOOT_TARGET) $(INSTALLED_TOS_TARGET) $(TOYBOX_HOST) $(SMD_GEN_HOST)
	...
	@cp $(strip $(14)).dtb $(strip $1)/$(notdir $(strip $(14)))-bl.dtb
...
# $4 Partition xml
# $5 Kernel dtb
# $6 Bootloader dtb path w/o suffix
...
# $2 Partition xml
# $3 Kernel dtb
# $4 Bootloader dtb path w/o suffix
...
$(eval $(call p2771_bl_signing_rule, $(P2771-C03_SIGNED_PATH), c01, c03, $(QUILL_FLASH)/flash_android_t186.xml, tegra186-quill-p3310-1000-c03-00-base.dtb, $(QUILL_BL)/tegra186-quill-p3310-1000-c03-00-base))
