...
$(_lanai_br_bct): $(TOYBOX_HOST) $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
...
$(_quill_c03_br_bct): $(TOYBOX_HOST) $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
...
$(_quill_c04_br_bct): $(TOYBOX_HOST) $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
	@cp $(QUILL_FLASH)/flash_android_t186.xml $(dir $@)/flash_android_t186.xml.tmp
	@cp $(T186_BL)/* $(dir $@)/
	@cp $(INSTALLED_CBOOT_TARGET) $(dir $@)/cboot.bin
...
$(_quill_blob): $(_lanai_br_bct) $(_quill_c03_br_bct) $(_quill_c04_br_bct) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
